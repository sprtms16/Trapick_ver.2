...
<%
	...
	session.setAttribute("user_idx", 3);
%>
															...
															.each(
																	...
																	function(i,
																		...
																		if ($
																				.inArray(
																						el,
																						uniqueAvailableTags2) === -1) {
																			uniqueAvailableTags2
																					.push(el);
																			$(
																					'#target2')
																					.append(
																							"<option value =" + availableTags2[i] + ">"
																									+ availableTags2[i]
																									+ "</opeion>");
																		}
																	});
...
<body>
	<div id="slideshow">
		<div>
			<img
				src="https://cms.hostelworld.com/hwblog/wp-content/uploads/sites/2/2017/08/girlgoneabroad-1170x805.jpg">
		</div>
		<div>
			<img
				src="https://www.eslstarter.com/admin/resources/full-width/spain-countryre-w1440h800.jpg">
		</div>
		<div>
			<img
				src="https://media.allure.com/photos/5bf1b1502ab5072a91e1853a/16:9/w_1600%2Cc_limit/travel%20editor%20favorite%20products.jpg">
		</div>
	</div>
	<form action="/recommend/scheduleDetail" method="post" id="mfrom">
		...
		<div id="container">
			<div id="contents">
				<input id="target" type="text" name="country_name"> <select
					id="target2" name="city_name">
					<option value="">::선택::</option>
				</select> <label for="start_time">출발일 : </label> <input type="text"
					name="start_time" id="start_time" autocomplete=off> ~ <label
					for="end_time">도착일 : </label> <input type="text" name="end_time"
					id="end_time" autocomplete=off> <input value="생성"
					id="submit" type="submit" class="booking_button trans_200">
