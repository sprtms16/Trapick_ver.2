...
<<<<<<< HEAD
   ...
   public List<ScheduleVO> scheduleList(UserVO userVO) {
    ...
    for(int i=0; i<listTemp.size();i++){
       ...
       ScheduleVO vo = new ScheduleVO(listTemp.get(i).getSchd_idx(), listTemp.get(i).getTitle(), tempStart, tempEnd, listTemp.get(i).getUser_idx(), listTemp.get(i).getSelectedLandmarkds(), listTemp.get(i).getSelectedItems());
