...
public class MyPageController {
	...
	public void list(Model model, HttpSession session) {
		...
		if (userVO.getImg_path() == null) {
			userVO.setImg_path("/resources/image/profile_image.jpg");
		} else {
	...
	public String share(@PathVariable("user") int user, @PathVariable("schd_idx") int schd_idx, RedirectAttributes rttr,
			HttpSession session) {
