...
public class CrawlingCommonServiceImpl implements CrawlingCommonService {
	...
	@Override
	   public String getLatitude(String cityName, String placeName) {
	      ...
	      String url_location = "https://maps.googleapis.com/maps/api/geocode/xml?address=" + placeName + "&key=AIzaSyDb_uxF2qi4zB5K51p-m6WDNrnTeTchSOw";
	      ...
	      try {
	         ...
	         if (latitude.length() < 10 || latitude == null) {
	            String url_temp = "https://maps.googleapis.com/maps/api/geocode/xml?address=" + cityName + "&key=AIzaSyDb_uxF2qi4zB5K51p-m6WDNrnTeTchSOw";
	   ...
	   public double getDist(String city_name, String base_point, String latitude, String longitude){
		   ...
		   try {
			   ...
			   String urlBase = "https://maps.googleapis.com/maps/api/geocode/xml?address=" + city_name+base_point + "&key=AIzaSyDb_uxF2qi4zB5K51p-m6WDNrnTeTchSOw";
		       ...
		       if (latBaseTemp.length() < 10 || latBaseTemp == null) {
				   urlBase = "https://maps.googleapis.com/maps/api/geocode/xml?address=" + city_name+base_point + "&key=AIzaSyDb_uxF2qi4zB5K51p-m6WDNrnTeTchSOw";
